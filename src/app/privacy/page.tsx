        ...
        <div className="container-custom px-6">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-2xl font-bold text-dark-900 mb-4">1. Information We Collect</h2>
              <p className="text-dark-600 mb-6">
                We collect information you provide directly to us, such as when you contact us, 
                request a quote, or fill out forms on our website. This may include:
              </p>
            ...
            >
              <h2 className="text-2xl font-bold text-dark-900 mb-4">2. How We Use Your Information</h2>
              <p className="text-dark-600 mb-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h2 className="text-2xl font-bold text-dark-900 mb-4">3. Information Sharing</h2>
              <p className="text-dark-600 mb-6">
            ...
            >
              <h2 className="text-2xl font-bold text-dark-900 mb-4">6. Cookies and Tracking</h2>
              <p className="text-dark-600 mb-6">
            ...
            >
              <h2 className="text-2xl font-bold text-dark-900 mb-4">7. Third-Party Services</h2>
              <p className="text-dark-600 mb-6">
            ...
            >
              <h2 className="text-2xl font-bold text-dark-900 mb-4">10. Contact Us</h2>
              <p className="text-dark-600 mb-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-dark-600">
                  <strong>Email:</strong> privacy@techflow.agency<br />
